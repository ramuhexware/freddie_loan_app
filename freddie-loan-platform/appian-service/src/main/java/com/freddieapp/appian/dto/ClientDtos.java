package com.freddieapp.appian.dto;
...
public class ClientDtos {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class AppianLoanSubmitRequest {
        private String customerId;
        private String loanType;
        private BigDecimal loanAmount;
        private BigDecimal propertyValue;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class AppianLoanActionRequest {
        private String action; // e.g. "APPROVE", "REJECT", "REQUEST_DOCUMENTS"
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class AppianWebhookEvent {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class AppianActionResponse {
        private String loanId;
        private String status;
